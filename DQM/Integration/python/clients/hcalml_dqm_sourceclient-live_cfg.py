...
process.dqmSaver.tag = "HcalML" # to have a file saved as DQM_V..._Hcal2...
...
#	New Style
#-------------------------------------
process.load('DQM.HcalTasks.MLTask')
...
process.mlTask.runkeyVal = runType
process.mlTask.runkeyName = runTypeName
process.mlTask.tagRaw = rawTagUntracked
process.mlTask.subsystem = cms.untracked.string(subsystem)
process.mlTask.nLS = cms.untracked.uint32(10)
