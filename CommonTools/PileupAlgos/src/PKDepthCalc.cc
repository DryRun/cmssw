...
void PKDepthCalc::initialize(const std::string iMethodTag, const std::string iPtWeightFile) {
...
double PKDepthCalc::mvaValue(const float eta, const float phi, const float depth0, const float depth1, const float depth2, const float depth3, const float depth4, const float depth5, const float depth6){
